"""
Django settings for ETechShop project.
...
WSGI_APPLICATION = 'ETechShop.wsgi.application'
...
EMAIL_BACKEND = config('EMAIL_BACKEND', cast=str, default='smtp.gmail.com')
